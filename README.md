...
The script supports IPv4. Please check the [issues](https://github.com/diegomarzo/wireguard-install/issues) for ongoing development, bugs and planned features!
